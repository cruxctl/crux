...
| `internal/cli` | Operator command surface, managed-agent usage/cost/session/history/fallback workflows, local `expect`/`script` TUI execution and transcript import, and `crux update` install/update flow. |
