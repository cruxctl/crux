...
type Runner interface {
	Run(ctx context.Context, agent domain.Agent, execution domain.Execution, runtime domain.RuntimeConfig) Result
}
...
func (r *CommandRunner) Run(ctx context.Context, agent domain.Agent, execution domain.Execution, runtime domain.RuntimeConfig) Result {
	...
	cmd.Env = mergeEnv(os.Environ(), agent.Command.Env)
